 ...
 */
export class Chain extends ImplClone(IteratorBase) implements Debug {
  public Self!: Chain;

  public A!: IteratorBase;
  public B!: IteratorFace<this["A"]["Item"]>;

  public Item!: this["A"]["Item"];
  ...
  public clone(): this["Self"] {
    if (isDoubleEndedIterator(this.a) && isDoubleEndedIterator(this.b)) {
      return new ChainForDoubleEndedIterator(clone(this.a), clone(this.b));
    } else {
...
export const ImplChainForDoubleEndedIterator = <
  T extends AnyConstructor<Chain & DoubleEndedIterator>
>(
  Base: T
) =>
  class ChainForDoubleEndedIterator extends Base {
    public Self!: ChainForDoubleEndedIterator;

    public A!: DoubleEndedIterator;
    public B!: DoubleEndedIterator;
...
export class ChainForDoubleEndedIterator extends ImplChainForDoubleEndedIterator(
  ImplDoubleEndedIterator(Chain)
) {}
...
declare module "./iter" {
  interface IteratorFace {
     ...
     */
    chain<Self extends DoubleEndedIterator, U extends IntoIterator<Self["Item"]>>(
      this: Self,
      other: U
    ): ChainForDoubleEndedIterator;
    chain<Self extends IteratorBase, U extends IntoIterator<Self["Item"]>>(
      this: Self,
      other: U
    ): Chain;
  }
...
function chain<Self extends DoubleEndedIterator, U extends IntoIterator<Self["Item"]>>(
  this: Self,
  other: U
): ChainForDoubleEndedIterator;
function chain<Self extends IteratorBase, U extends IntoIterator<Self["Item"]>>(
  this: Self,
  other: U
): Chain;
function chain(this: any, other: any): any {
  if (isDoubleEndedIterator(this)) {
    return new ChainForDoubleEndedIterator(this, other.into_iter());
  } else {
