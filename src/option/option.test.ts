// import { Option, OptionIter } from "./option";
// import { Result } from "../internal";
//
// describe("[Symbol.iterator]", () => {
//   test("return OptionIter for Some()", () => {
//     const some = Option.Some("something");
//     expect(some[Symbol.iterator]()).toBeInstanceOf(OptionIter);
//   });
//
//   test("return OptionIter for None()", () => {
//     const none = Option.None();
//     expect(none[Symbol.iterator]()).toBeInstanceOf(OptionIter);
//   });
// });
//
// describe(".isSome", () => {
...
//   test("throw for None()", () => {
//     const none = Option.None();
//     expect(() => none.expect('expected "something"')).toThrowError('expected "something"');
//   });
// });
//
// describe(".unwrap", () => {
...
//   test("throw for None()", () => {
//     const none = Option.None();
//     expect(() => none.unwrap()).toThrowError("unwrap: Expected Some(), was None()");
//   });
// });
//
// describe(".unwrapOr", () => {
...
//   test("return value of fallback() for None", () => {
//     const none = Option.None();
//     expect(none.okOr("Something went wrong")).toEqual(Result.Err("Something went wrong"));
//   });
// });
//
// describe(".okOrErlse", () => {
...
//   test("return value of fallback() for None", () => {
//     const none = Option.None();
//     expect(none.okOrElse(() => "Something went wrong")).toEqual(Result.Err("Something went wrong"));
//   });
// });
//
// describe(".and", () => {
